...
- Name: auth-flows.spec.ts >> a verified user can request a reset link, reset the password, and sign in again
- Location: e2e/auth-flows.spec.ts:54:1
...
- generic [ref=e4]:
  ...
  - generic [ref=e8]:
    - generic [ref=e9]:
      ...
      - textbox "Email" [ref=e11]: reader+1776268978368-1866@example.com
    - generic [ref=e12]:
      - generic [ref=e13]: Password
      - textbox "Password" [ref=e14]: ResetMe456!
